...
class $RecurringRulesTable extends RecurringRules
  ...
  @override
  late final GeneratedColumn<String> nextRunDate = GeneratedColumn<String>(
    'next_run_date',
    aliasedName,
    false,
    type: DriftSqlType.string,
...
class RecurringRule extends DataClass implements Insertable<RecurringRule> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['next_run_date'] = Variable<String>(nextRunDate);
    map['is_active'] = Variable<int>(isActive);
    map['created_at'] = Variable<String>(createdAt);
    return map;
  }
  ...
  factory RecurringRule.fromJson(
    ...
    return RecurringRule(
      ...
      nextRunDate: serializer.fromJson<String>(json['nextRunDate']),
      isActive: serializer.fromJson<int>(json['isActive']),
      createdAt: serializer.fromJson<String>(json['createdAt']),
    );
  }
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'nextRunDate': serializer.toJson<String>(nextRunDate),
      'isActive': serializer.toJson<int>(isActive),
      'createdAt': serializer.toJson<String>(createdAt),
    };
  }
...
class RecurringRulesCompanion extends UpdateCompanion<RecurringRule> {
  ...
  final Value<String> nextRunDate;
  final Value<int> isActive;
  final Value<String> createdAt;
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (nextRunDate.present) {
      map['next_run_date'] = Variable<String>(nextRunDate.value);
    }
    if (isActive.present) {
      map['is_active'] = Variable<int>(isActive.value);
    }
...
class $TransactionsTable extends Transactions
  ...
  @override
  late final GeneratedColumn<double> transferFee = GeneratedColumn<double>(
    'transfer_fee',
    aliasedName,
    false,
    type: DriftSqlType.double,
...
class Transaction extends DataClass implements Insertable<Transaction> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['transfer_fee'] = Variable<double>(transferFee);
  ...
  factory Transaction.fromJson(
    ...
    return Transaction(
      ...
      transferFee: serializer.fromJson<double>(json['transferFee']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'transferFee': serializer.toJson<double>(transferFee),
...
class TransactionsCompanion extends UpdateCompanion<Transaction> {
  ...
  final Value<double> transferFee;
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (transferFee.present) {
      map['transfer_fee'] = Variable<double>(transferFee.value);
    }
...
class $BudgetsTable extends Budgets with TableInfo<$BudgetsTable, Budget> {
  ...
  @override
  late final GeneratedColumn<int> notifyAt80 = GeneratedColumn<int>(
    'notify_at80',
    aliasedName,
    false,
    type: DriftSqlType.int,
...
class Budget extends DataClass implements Insertable<Budget> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['notify_at80'] = Variable<int>(notifyAt80);
    map['created_at'] = Variable<String>(createdAt);
    return map;
  }
  ...
  factory Budget.fromJson(
    ...
    return Budget(
      ...
      startDate: serializer.fromJson<String>(json['startDate']),
      endDate: serializer.fromJson<String?>(json['endDate']),
      notifyAt80: serializer.fromJson<int>(json['notifyAt80']),
      createdAt: serializer.fromJson<String>(json['createdAt']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'startDate': serializer.toJson<String>(startDate),
      'endDate': serializer.toJson<String?>(endDate),
      'notifyAt80': serializer.toJson<int>(notifyAt80),
      'createdAt': serializer.toJson<String>(createdAt),
    };
  }
...
class BudgetsCompanion extends UpdateCompanion<Budget> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (notifyAt80.present) {
      map['notify_at80'] = Variable<int>(notifyAt80.value);
    }
    if (createdAt.present) {
      map['created_at'] = Variable<String>(createdAt.value);
    }
...
class Achievement extends DataClass implements Insertable<Achievement> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, title, description, achievedAt, type, targetAmount);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
final class $$CategoriesTableReferences
  ...
  static MultiTypedResultKey<$UserDictionaryTable, List<UserDictionaryData>>
  _userDictionaryRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.userDictionary,
    aliasName: $_aliasNameGenerator(
      db.categories.id,
      db.userDictionary.categoryId,
    ),
  );

  $$UserDictionaryTableProcessedTableManager get userDictionaryRefs {
    final manager = $$UserDictionaryTableTableManager(
      $_db,
      $_db.userDictionary,
    ).filter((f) => f.categoryId.id.sqlEquals($_itemColumn<int>('id')!));

    final cache = $_typedResult.readTableOrNull(_userDictionaryRefsTable($_db));
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
  }
...
class $$CategoriesTableFilterComposer
  ...
  Expression<bool> userDictionaryRefs(
    Expression<bool> Function($$UserDictionaryTableFilterComposer f) f,
  ) {
    final $$UserDictionaryTableFilterComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.userDictionary,
      getReferencedColumn: (t) => t.categoryId,
      builder:
          (
            joinBuilder, {
...
class $$CategoriesTableAnnotationComposer
  ...
  Expression<T> userDictionaryRefs<T extends Object>(
    Expression<T> Function($$UserDictionaryTableAnnotationComposer a) f,
  ) {
    final $$UserDictionaryTableAnnotationComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.userDictionary,
      getReferencedColumn: (t) => t.categoryId,
              ...
              ({
                ...
                return PrefetchHooks(
                  ...
                  explicitlyWatchedTables: [
                    ...
                    if (userDictionaryRefs) db.userDictionary,
                  ],
                  addJoins: null,
...
final class $$WalletsTableReferences
  ...
  _recurringRulesRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.recurringRules,
    aliasName: $_aliasNameGenerator(db.wallets.id, db.recurringRules.walletId),
  );
  ...
  $$TransactionsTableProcessedTableManager get walletTransactions {
    final manager = $$TransactionsTableTableManager(
      $_db,
      $_db.transactions,
    ).filter((f) => f.walletId.id.sqlEquals($_itemColumn<int>('id')!));
  ...
  _toWalletTransactionsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.transactions,
    aliasName: $_aliasNameGenerator(db.wallets.id, db.transactions.toWalletId),
  );

  $$TransactionsTableProcessedTableManager get toWalletTransactions {
    final manager = $$TransactionsTableTableManager(
      $_db,
      $_db.transactions,
          ...
          prefetchHooksCallback:
              ({
                ...
                return PrefetchHooks(
                  ...
                  explicitlyWatchedTables: [
                    if (recurringRulesRefs) db.recurringRules,
                    if (walletTransactions) db.transactions,
                    if (toWalletTransactions) db.transactions,
                  ],
                  addJoins: null,
                  getPrefetchedDataCallback: (items) async {
                    return [
...
class $$RecurringRulesTableFilterComposer
  ...
  ColumnFilters<String> get nextRunDate => $composableBuilder(
...
class $$RecurringRulesTableOrderingComposer
  ...
  ColumnOrderings<String> get nextRunDate => $composableBuilder(
    column: $table.nextRunDate,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$RecurringRulesTableAnnotationComposer
  ...
  GeneratedColumn<String> get nextRunDate => $composableBuilder(
    column: $table.nextRunDate,
    builder: (column) => column,
  );
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<String?> endDate = const Value.absent(),
                Value<String> nextRunDate = const Value.absent(),
                Value<int> isActive = const Value.absent(),
                Value<String> createdAt = const Value.absent(),
...
class $$TransactionsTableFilterComposer
  ...
  ColumnFilters<double> get transferFee => $composableBuilder(
...
class $$TransactionsTableOrderingComposer
  ...
  ColumnOrderings<double> get transferFee => $composableBuilder(
    column: $table.transferFee,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$TransactionsTableAnnotationComposer
  ...
  GeneratedColumn<double> get transferFee => $composableBuilder(
    column: $table.transferFee,
    builder: (column) => column,
  );
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<int> walletId = const Value.absent(),
                Value<int?> toWalletId = const Value.absent(),
                Value<double> transferFee = const Value.absent(),
                Value<String?> transferGroupId = const Value.absent(),
...
class $$BudgetsTableFilterComposer
  ...
  ColumnFilters<int> get notifyAt80 => $composableBuilder(
...
class $$BudgetsTableOrderingComposer
  ...
  ColumnOrderings<int> get notifyAt80 => $composableBuilder(
    column: $table.notifyAt80,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$BudgetsTableAnnotationComposer
  ...
  GeneratedColumn<int> get notifyAt80 => $composableBuilder(
    column: $table.notifyAt80,
    builder: (column) => column,
  );
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<String> startDate = const Value.absent(),
                Value<String?> endDate = const Value.absent(),
                Value<int> notifyAt80 = const Value.absent(),
                Value<String> createdAt = const Value.absent(),
              }) => BudgetsCompanion(
                id: id,
                categoryId: categoryId,
...
final class $$UserDictionaryTableReferences
    extends
        BaseReferences<
          _$AppDatabase,
          $UserDictionaryTable,
  ...
  static $CategoriesTable _categoryIdTable(_$AppDatabase db) =>
      db.categories.createAlias(
        $_aliasNameGenerator(db.userDictionary.categoryId, db.categories.id),
      );
...
class $$UserDictionaryTableTableManager
    extends
        RootTableManager<
          ...
          (UserDictionaryData, $$UserDictionaryTableReferences),
          UserDictionaryData,
          PrefetchHooks Function({bool categoryId})
        > {
        ...
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable(table),
                  $$UserDictionaryTableReferences(db, table, e),
                ),
              )
              .toList(),
          prefetchHooksCallback: ({categoryId = false}) {
                    ...
                    if (categoryId) {
                      state =
                          state.withJoin(
                                currentTable: table,
                                currentColumn: table.categoryId,
                                referencedTable: $$UserDictionaryTableReferences
                                    ._categoryIdTable(db),
                                referencedColumn:
                                    $$UserDictionaryTableReferences
                                        ._categoryIdTable(db)
